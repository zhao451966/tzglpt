(function() {
    ...
    angular.module('demo.core')
        .directive('fxContinueUploader', FxContinueUploaderDirective);
    ...
    /* @ngInject */
    function FxContinueUploaderDirective($parse,$translate) {
        var directive = {
            restrict: 'A',
            require: '?ngModel',
        ...
        function linkFn(scope, element, attrs, ngModel) {
            ...
            if (attrs.fxContinueUploader) {
                options = $parse(attrs.fxContinueUploader)(scope);
            }
            ...
            var upload=$translate.instant('N004557');//N004557'=继续选取文件


            var DEFAULT_CONFIGS = {
                browseFileId : "i_select_files",
                /** 选择文件的ID, 默认: i_select_files */
                browseFileBtn :"<button class='browse-file continue-select'>" +
