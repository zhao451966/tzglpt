(function() {
    ...
    angular.module('demo.core')
        .controller('DialogUserLableController', DialogUserLableController);

    /* @ngInject */
    function DialogUserLableController($scope, $timeout, Restangular, selected,UserInfoAPI) {
        var vm = this;
        ...
        vm.searchUserByName=function(){
            ...
            if(selected){
            	if($scope.ngDialogData.selectionMode == 'single'){
            		...
            		//查询一个用户
            		Restangular.all('matterreport/findUserInfoList')
                    .customGETLIST('',param)
                    .then(function(data) {
						if(data){
                    		vm.users = data;
