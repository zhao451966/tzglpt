(function() {
    ...
    angular.module('demo.core')
        .controller('DialogNewUnitUserController', DialogNewUnitUserController);

    /* @ngInject */
    function DialogNewUnitUserController($scope, $timeout, Restangular, selected) {
		...
		vm.showPath=false;
		/*vm.getList=function(code,path){
			var param={s_type:"init-multiple",s_parentUnit:code};
			param=angular.extend(param,$scope.$$params);
			Restangular.all('unitinfo/listNewUnitUser')
				.customGETLIST('',param)
				.then(function(data) {
