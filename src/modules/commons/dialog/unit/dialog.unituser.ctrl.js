(function() {
    ...
    angular.module('demo.core')
        .controller('DialogUnitUserController', DialogUnitUserController);

    /* @ngInject */
    function DialogUnitUserController($scope, $timeout, Restangular, selected) {
        ...
        vm.searchUnitByName=function(){
			...
			if(selected){
				if($scope.ngDialogData.selectionMode == 'single'){
					...
					//查询一个部门
					Restangular.all('unitinfo/listUnitUser')
						.customGETLIST('',param)
						.then(function(data) {
							if(data){
								vm.units = data;
