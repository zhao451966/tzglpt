(function() {
    ...
    angular.module('demo.core')
        .controller('DialogUserFxtController', DialogUserFxtController);

    /* @ngInject */
    function DialogUserFxtController($scope, $timeout, Restangular, selected,UserInfoAPI) {
        var vm = this;
