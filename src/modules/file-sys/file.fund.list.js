(function () {
    ...
    angular
        .module('fosun.file')
        .controller('FileFundListController', FileFundListController);


    /* @ngInject */
    function FileFundListController($stateParams,$scope,$rootScope,$document, toastr, $state, Restangular,Confirm,$translate,ngDialog,ngPdfDialog) {
        var vm = this;

        $rootScope.visible=true;
        vm.fileListTitle={
            title:$translate.instant('N004533'),//N004533='已披露文件'
            company:$translate.instant('N109058'),//N109058='公司名称'
